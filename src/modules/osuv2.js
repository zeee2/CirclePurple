...
let osutoken_data = await get_token()
console.log(osutoken_data.expires_in)
let osutoken = osutoken_data.access_token

const refresh_token = (async () => {
    let expire = Math.floor(new Date().getTime() / 1000) + osutoken_data.expires_in
...
export default {
    get_beatmap_info: async (beatmap_id) => {
    ...
    get_beatmapsets_info: async (beatmapsets_id) => {
